...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ag cider command-log-mode company counsel counsel-projectile
        dart-mode diminish eat edn evil evil-terminal-cursor-changer
        expand-region eziam-themes flycheck haskell-mode ivy-prescient
        ivy-rich liberime lsp-haskell lsp-pyright lsp-ui magit
        org-bullets paredit projectile racket-mode rime scribble-mode
...
(add-to-list 'exec-path "/home/ysong/.nvm/versions/node/v22.22.0/bin")

(let ((node-v22-path "/home/ysong/.nvm/versions/node/v22.22.0/bin"))
  (setenv "PATH" (concat node-v22-path ":" (getenv "PATH")))
  (add-to-list 'exec-path node-v22-path))
